...
if (typeof document == 'undefined') {
    // Use official @kusto/language-service-next package instead of vendored files
...
var KustoLanguageService = /** @class */ (function () {
    ...
    KustoLanguageService.prototype.doCompleteV2 = function (document, position) {
        ...
        var items = this.toArray(completionItems.Items)
            ...
            .map(function (kItem, i) {
                var v1CompletionOption = new k.CompletionOption(
                    _this._toOptionKind[kItem.Kind] || k.OptionKind.None,
                    kItem.DisplayText
                );
        ...
        if (rule) {
            ...
            var options = completionOptions
                ...
                .map(function (option, ordinal) {
                    var _a = _this.getTextToInsert(rule, option),
                        insertText = _a.insertText,
                        insertTextFormat = _a.insertTextFormat;
            ...
            var result = affectedBlocks.map(function (block) {
                return {
                    classifications: toClassifiedRange(
                        _this.toArray(block.Service.GetClassifications(block.Start, block.End).Classifications)
                    ),
    ...
    KustoLanguageService.prototype.setParameters = function (parameters) {
        ...
        var symbols = parameters.map(function (param) {
     ...
     */
    KustoLanguageService.prototype.setSchemaFromShowSchema = function (
        schema,
            ...
            .map(function (_a) {
                ...
                return {
                    ...
                    tables: Object.keys(Tables)
                        ...
                        .map(function (_a) {
                            var Name = _a.Name,
                                OrderedColumns = _a.OrderedColumns,
                    ...
                    functions: Object.keys(Functions)
                        ...
                        .map(function (_a) {
                            var Name = _a.Name,
                                Body = _a.Body,
                                DocString = _a.DocString,
                                InputParameters = _a.InputParameters;
                            return {
                                name: Name,
                                body: Body,
                                docstring: DocString,
                                inputParameters: InputParameters.map(function (inputParam) {
                                    return {
                                        ...
                                        columns: inputParam.Columns
                                            ? inputParam.Columns.map(function (col) {
                                                  return {
                                                      name: col.Name,
                                                      type: col.Type,
                                                      cslType: col.CslType
    ...
    KustoLanguageService.prototype.getCommandsInDocumentV1 = function (document) {
        ...
        return Promise.resolve(
            commands.map(function (_a) {
                var AbsoluteStart = _a.AbsoluteStart,
                    AbsoluteEnd = _a.AbsoluteEnd,
                    Text = _a.Text;
                return {
    ...
    KustoLanguageService.prototype.getFormattedCommandsInDocumentV2 = function (document, rangeStart, rangeEnd) {
        ...
        var formattedCommands = commands.map(function (command) {
            ...
            var formatter = Kusto.Language.Editor.FormattingOptions.Default.WithIndentationSize(
                (_a =
                    formatterOptions === null || formatterOptions === void 0
                        ? void 0
                        : formatterOptions.indentationSize) !== null && _a !== void 0
                    ? _a
                    : 4
            )
                .WithInsertMissingTokens(false)
                .WithPipeOperatorStyle(
                    (_b = _this.toPlacementStyle(
                        formatterOptions === null || formatterOptions === void 0
                            ? void 0
                            : formatterOptions.pipeOperatorStyle
                    )) !== null && _b !== void 0
                        ? _b
                        : k2.PlacementStyle.Smart
                )
    ...
    KustoLanguageService.prototype.getQueryParams = function (document, cursorOffset) {
        ...
        var queryParamStatements = this.toArray(
    ...
    KustoLanguageService.prototype.getRenderInfo = function (document, cursorOffset) {
        ...
        var renderStatements = this.toArray(
    ...
    KustoLanguageService.prototype.getReferencedGlobalParams = function (document, cursorOffset) {
        ...
        var referencedSymbols = this.toArray(parsedAndAnalyzed.Syntax.GetDescendants(Kusto.Language.Syntax.Expression))
            .filter(function (epression) {
                return epression.ReferencedSymbol !== null;
            })
            .map(function (x) {
        ...
        var intersection = referencedSymbols.filter(function (referencedSymbol) {
            return (
                ambientParameters.filter(function (ambientParameter) {
                    return ambientParameter === referencedSymbol;
                }).length > 0
            );
        });
        var result = intersection.map(function (param) {
            return { name: param.Name, type: param.Type.Name };
        });
        return Promise.resolve(result);
    };
    ...
    KustoLanguageService.createParameter = function (param) {
        ...
        var argumentType = new sym.TableSymbol.ctor(
            param.columns.map(function (col) {
    ...
    KustoLanguageService.convertToDatabaseSymbol = function (db, globalState, addFunctions) {
        ...
        var createDatabaseSymbol = function (db) {
            var tableSymbols = db.tables
                ? db.tables.map(function (tbl) {
                      return createTableSymbol(tbl);
                  })
                : [];
            var functionSymbols = db.functions
                ? db.functions.map(function (fun) {
    ...
    KustoLanguageService.prototype.convertToKustoJsSchemaV2 = function (schema) {
        ...
        var databases = schema.cluster.databases.map(function (db) {
            ...
            if (
                ...
                var databaseSymbol_1 = KustoLanguageService.convertToDatabaseSymbol(
                    db,
                    globalState,
    ...
    KustoLanguageService.prototype.getClassificationsFromParseResult = function (offset) {
        ...
        var classifications = this.toArray(this._parser.Results)
            .map(function (command) {
                return _this.toArray(command.Tokens);
            })
            .reduce(function (prev, curr) {
                return prev.concat(curr);
            }, [])
            .map(function (cslCommandToken) {
                var range = new k2.ClassifiedRange(
                    _this.tokenKindToClassificationKind(cslCommandToken.TokenKind),
    ...
    KustoLanguageService.prototype.createRulesProvider = function (schema, clusterType) {
        ...
        var _a = schema,
            ...
            connectionString = _a.connectionString;
